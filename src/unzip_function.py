...
#It is necessary to create a function to unzip the CIS folder:

def unzip_data(studies_folder: str, studies_list: list, unziped_files_folder: str) -> folder:
...
unzip_data('qualitative_zipped_data', [3251], 'unziped_data')
